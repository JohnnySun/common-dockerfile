...
``` sh
docker run -dt --name ss -p 6443:6443 floundersoft/shadowsocks -s "-s 0.0.0.0 -p 6443 -m chacha20 -k test123 --fast-open"
```
...
``` sh
docker run -dt --name ssserver -p 6443:6443 -p 6500:6500/udp flounderdoft/shadowsocks -m "ss-server" -s "-s 0.0.0.0 -p 6443 -m chacha20 -k test123 --fast-open" -x -e "kcpserver" -k "-t 127.0.0.1:6443 -l :6500 -mode fast2"
```
...
``` sh
docker run -dt --name ssclient -p 1080:1080 floundersoft/shadowsocks -m "ss-local" -s "-s 127.0.0.1 -p 6500 -b 0.0.0.0 -l 1080 -m chacha20 -k test123 --fast-open" -x -e "kcpclient" -k "-r SSSERVER_IP:6500 -l :6500 -mode fast2"
```
